...
void core::Window::SdlWindowDeleter::operator()(SDL_Window* sdl_window_handle) const
{
	SDL_DestroyWindow(sdl_window_handle);
}

// ReSharper disable once CppParameterMayBeConst
void core::Window::SdlContextDeleter::operator()(SDL_GLContext sdl_gl_context_handle) const
{
	SDL_GL_DestroyContext(sdl_gl_context_handle);
}

core::Window core::Window::initialize_with_context(const Config& config)
{
#ifdef _WIN32
...
b8 core::Window::should_stay_open() const
{
	return !m_should_close;
}

void core::Window::gl_swap() const
{
	SDL_GL_SwapWindow(m_window.get());
}

void core::Window::on_window_resizing(const i32 new_size_x, const i32 new_size_y)
{
	glViewport(0, 0, new_size_x, new_size_y);
}

void core::Window::on_window_quit_event()
{
	m_should_close = true;
}

void core::Window::handle_input(const EventHandler& event_handler)
{
...
SDL_Window* core::Window::get_window_handle() const
{
	return m_window.get();
}

SDL_GLContext core::Window::get_gl_context() const
{
	return m_gl_context.get();
}

glm::vec2 core::Window::get_resolution() const
{
	i32 x, y;
...
f32 core::Window::get_aspect_ratio() const
{
